...
DECLARE_MIDFUNC(jnf_MEM_READ_GUARDED_l(W4 dest, RR4 adr, IM8 offset));
DECLARE_MIDFUNC(jnf_MEM_READ_GUARDED_w(W4 dest, RR4 adr, IM8 offset));
DECLARE_MIDFUNC(jnf_MEM_READ_GUARDED_b(W4 dest, RR4 adr, IM8 offset));
DECLARE_MIDFUNC(jnf_MEM_READ_GUARDED_NS_l(W4 d, RR4 adr));
