...
MIDFUNC(2,jnf_MEM_WRITE_OFF_w,(RR4 adr, RR4 w))
{
	...
	REV16_ww(REG_WORK1, w);
	MOV_ww(REG_WORK3, adr);
	STRH_wXx(REG_WORK1, REG_WORK3, R_MEMSTART);
...
MIDFUNC(2,jnf_MEM_WRITE_OFF_l,(RR4 adr, RR4 l))
{
	...
	REV_ww(REG_WORK1, l);
	MOV_ww(REG_WORK3, adr);
	STR_wXx(REG_WORK1, REG_WORK3, R_MEMSTART);
...
MIDFUNC(2,jnf_MEM_READ_OFF_l,(W4 d, RR4 adr))
{
	...
	//REV_ww(d, REG_WORK1);
	MOV_ww(REG_WORK1, adr);
	LDR_wXx(REG_WORK1, REG_WORK1, R_MEMSTART);
	REV_ww(d, REG_WORK1);
