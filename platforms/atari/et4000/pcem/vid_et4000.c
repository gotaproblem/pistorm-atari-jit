...
static uint8_t crtc_mask[0x40] = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
void et4000k_out(uint16_t addr, uint8_t val, void *p) {
        ...
        case 0x22CF:
                ...
                case 1:
                        ...
                        break;
                case 2:
                        et4000->get_korean_font_base =
                                (et4000->get_korean_font_base & 0x3F80) | (val & 0x7F) | (((val ^ 0x80) & 0x80) << 8);
                        break;
                case 3:
                        if ((et4000->port_32cb_val & 0x30) == 0x20 && (et4000->get_korean_font_base & 0x7F) > 0x20 &&
                            (et4000->get_korean_font_base & 0x7F) < 0x7F) {
                                switch (et4000->get_korean_font_base & 0x3F80) {
                                case 0x2480:
                                        if (et4000->get_korean_font_index < 16)
                                                fontdatksc5601_user[(et4000->get_korean_font_base & 0x7F) - 0x20]
                                                                   [et4000->get_korean_font_index] = val;
                                        else if (et4000->get_korean_font_index >= 24 && et4000->get_korean_font_index < 40)
                                                fontdatksc5601_user[(et4000->get_korean_font_base & 0x7F) - 0x20]
                                                                   [et4000->get_korean_font_index - 8] = val;
                                        break;
                                case 0x3F00:
                                        if (et4000->get_korean_font_index < 16)
                                                fontdatksc5601_user[96 + (et4000->get_korean_font_base & 0x7F) - 0x20]
                                                                   [et4000->get_korean_font_index] = val;
                                        else if (et4000->get_korean_font_index >= 24 && et4000->get_korean_font_index < 40)
                                                fontdatksc5601_user[96 + (et4000->get_korean_font_base & 0x7F) - 0x20]
                                                                   [et4000->get_korean_font_index - 8] = val;
        ...
        if (addr == 0x258) {
                ...
                if (et4000->kasan_cfg_index >= 0xF0) {
                        ...
                        case 2:
                                ...
                                io_removehandler(et4000->kasan_access_addr, 0x0008, et4000_kasan_in, NULL, NULL, et4000_kasan_out,
                                                 NULL, NULL, et4000);
                                et4000->kasan_access_addr = (et4000->kasan_cfg_regs[2] << 8) | et4000->kasan_cfg_regs[1];
                                io_sethandler(et4000->kasan_access_addr, 0x0008, et4000_kasan_in, NULL, NULL, et4000_kasan_out,
                                              NULL, NULL, et4000);
                ...
                case 5:
                        if (et4000->kasan_cfg_regs[0] & 1) {
                                et4000->kasan_font_data[addr - (((et4000->kasan_cfg_regs[2] << 8) | (et4000->kasan_cfg_regs[1])) +
                                                                3)] = val;
                        }
                        break;
                case 6:
                        if ((et4000->kasan_cfg_regs[0] & 1) && (et4000->kasan_font_data[3] & !val & 0x80) &&
                            (et4000->get_korean_font_base & 0x7F) >= 0x20 && (et4000->get_korean_font_base & 0x7F) < 0x7F) {
                                if (((et4000->get_korean_font_base >> 7) & 0x7F) ==
                                            (et4000->svga.ksc5601_udc_area_msb[0] & 0x7F) &&
                                    (et4000->svga.ksc5601_udc_area_msb[0] & 0x80)) {
                                        fontdatksc5601_user[(et4000->get_korean_font_base & 0x7F) - 0x20]
                                                           [et4000->get_korean_font_index] = et4000->kasan_font_data[2];
                                } else if (((et4000->get_korean_font_base >> 7) & 0x7F) ==
                                                   (et4000->svga.ksc5601_udc_area_msb[1] & 0x7F) &&
                                           (et4000->svga.ksc5601_udc_area_msb[1] & 0x80)) {
                                        fontdatksc5601_user[96 + (et4000->get_korean_font_base & 0x7F) - 0x20]
                                                           [et4000->get_korean_font_index] = et4000->kasan_font_data[2];
                                }
                        }
...
uint8_t et4000k_in(uint16_t addr, void *p) {
        ...
        case 0x22CF:
                ...
                case 3:
                        ...
                        } else if ((et4000->port_32cb_val & 0x30) == 0x20 && (et4000->get_korean_font_base & 0x7F) > 0x20 &&
                                   (et4000->get_korean_font_base & 0x7F) < 0x7F) {
                                switch (et4000->get_korean_font_base & 0x3F80) {
                                case 0x2480:
                                        if (et4000->get_korean_font_index < 16)
                                                val = fontdatksc5601_user[(et4000->get_korean_font_base & 0x7F) - 0x20]
                                                                         [et4000->get_korean_font_index];
                                        else if (et4000->get_korean_font_index >= 24 && et4000->get_korean_font_index < 40)
                                                val = fontdatksc5601_user[(et4000->get_korean_font_base & 0x7F) - 0x20]
                                                                         [et4000->get_korean_font_index - 8];
                                        break;
                                case 0x3F00:
                                        if (et4000->get_korean_font_index < 16)
                                                val = fontdatksc5601_user[96 + (et4000->get_korean_font_base & 0x7F) - 0x20]
                                                                         [et4000->get_korean_font_index];
                                        else if (et4000->get_korean_font_index >= 24 && et4000->get_korean_font_index < 40)
                                                val = fontdatksc5601_user[96 + (et4000->get_korean_font_base & 0x7F) - 0x20]
                                                                         [et4000->get_korean_font_index - 8];
...
uint8_t et4000_kasan_in(uint16_t addr, void *p) {
        ...
        if (addr == 0x258) {
                ...
                case 2:
                        ...
                        break;
                case 5:
                        if (((et4000->get_korean_font_base >> 7) & 0x7F) == (et4000->svga.ksc5601_udc_area_msb[0] & 0x7F) &&
                            (et4000->svga.ksc5601_udc_area_msb[0] & 0x80)) {
                                val = fontdatksc5601_user[(et4000->get_korean_font_base & 0x7F) - 0x20]
                                                         [et4000->get_korean_font_index];
                        } else if (((et4000->get_korean_font_base >> 7) & 0x7F) ==
...
void *et4000k_init() {
        ...
        svga_init(&et4000->svga, et4000, 1 << 20, /*1mb*/
                  et4000k_recalctimings, et4000k_in, et4000k_out, NULL, NULL);
...
void *et4000_kasan_init() {
        ...
        svga_init(&et4000->svga, et4000, 1 << 20, /*1mb*/
                  et4000_kasan_recalctimings, et4000_in, et4000_out, NULL, NULL);
...
static int et4000_available() { return rom_present("et4000.bin"); }
...
device_t et4000_device = {
        "Tseng Labs ET4000AX", 0, pcem_et4000_init, et4000_close, et4000_available, et4000_speed_changed, et4000_force_redraw,
        et4000_add_status_info};

device_t et4000k_device = {"Trigem Korean VGA(Tseng Labs ET4000AX)",
                           0,
                           et4000k_init,
                           et4000_close,
                           et4000k_available,
...
device_t et4000_kasan_device = {"Kasan Hangulmadang-16(Tseng Labs ET4000AX)",
                                0,
                                et4000_kasan_init,
                                et4000_close,
