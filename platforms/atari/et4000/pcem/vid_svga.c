...
/*
        fprintf (stderr, "SVGA_RECALCTIMINGS(): hdisp 0x%X, htotal 0x%X, blankstart 0x%X, split 0x%X\n",
                svga->hdisp, svga->htotal, svga->vblankstart, svga->split
        );

        fprintf (stderr, "SVGA_RECALCTIMINGS(): gdcreg[5] 0x%X, seqregs[1] 0x%X, bpp %d\n",
                svga->gdcreg[5], svga->seqregs[1], svga->bpp
        );
*/
